...
const fetchPages = ({
  ...
  limit
    ...
    query {
      ${fieldName} {
        ${models.map((model, index) => `${model}(limit: ${limit}, offset: ${offsets[index]}, options: { cacheSeconds: 2, staleCacheSeconds: 2 }) {
            content
          }`).join(` `)}
      }
    }
...
function getPaths(content) {
  var _content$query, _content$query$find;
  let urls = content === null || content === void 0 ? void 0 : (_content$query = content.query) === null || _content$query === void 0 ? void 0 : (_content$query$find = _content$query.find(attribute => attribute.property === 'urlPath')) === null || _content$query$find === void 0 ? void 0 : _content$query$find.value;
